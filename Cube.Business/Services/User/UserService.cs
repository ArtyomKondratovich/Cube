...
using TokenValidationResult = Cube.Business.Utilities.TokenValidationResult;
...
namespace Cube.Business.Services.User
{
    public class UserService : IUserService
    {
        ...
        public async Task<Response<FriendshipModel, CreateFriendshipResult>> CreateFriendshipAsync(FriendshipDto dto)
        {
            ...
            var friendshipEntity = _mapper.Map<FriendshipEntity>(dto);
            ...
            response.Value = _mapper.Map<FriendshipModel>(result);
            return response;
        }
        ...
        public async Task<Response<List<UserModel>, GetUserFriends>> GetUserFriendsAsync(FindUserDto dto)
        {
            ...
            foreach (var friend in friendships)
            {
                ...
                if (userEntity != null) 
                {
                    friends.Add(_mapper.Map<UserModel>(userEntity));
                }
            }
        ...
        public async Task<Response<bool, RegisterResult>> Register(RegisterDto dto)
        {
            ...
            var savedMessages = new ChatEntity
            {
                ...
                Users = new List<UserEntity>() { createdUser },
