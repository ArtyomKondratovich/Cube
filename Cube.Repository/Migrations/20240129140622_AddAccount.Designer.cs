...
namespace Cube.EntityFramework.Migrations
{
    ...
    [Migration("20240129140622_AddAccount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cube.Core.Models.User.AccountModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Cube.Core.Models.User.UserModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Cube.Core.Models.ChatModel", b =>
                {
                    b.HasOne("Cube.Core.Models.User.UserModel", "ChatAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("Cube.Core.Models.MessageModel", b =>
                {
                    ...
                    b.HasOne("Cube.Core.Models.User.UserModel", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Cube.Core.Models.User.UserModel", b =>
                {
                    b.HasOne("Cube.Core.Models.User.AccountModel", "Account")
                        .WithMany()
